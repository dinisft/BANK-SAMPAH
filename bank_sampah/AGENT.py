...
🎯 DEVELOPMENT WORKFLOW RULES (ALL AI MODELS MUST FOLLOW):
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
1. LOCAL DEVELOPMENT: Make changes on localhost first
2. LOCAL TESTING: Run all tests on localhost (unit, integration, manual)
3. COMMIT & PUSH: Only push to GitHub after ALL local tests pass
4. CI/CD TESTING: Automated tests run on GitHub (GitHub Actions)
5. FAILURE ANALYSIS: If GitHub tests fail, analyze logs, fix, re-test locally, then push again
6. NO DIRECT PRODUCTION: Never deploy untested code
...
🚀 MANDATORY WORKFLOW FOR BANK SAMPAH APP:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
1. Edit code on localhost (C:\xampp\htdocs\bank_sampah)
2. Test locally: Run PHP syntax check, test all user flows (nasabah + admin)
3. Verify DB schema matches code (check bank_sampah.sql vs PHP queries)
4. Only commit & push to GitHub if ALL local tests pass
5. GitHub Actions runs automated tests (PHP syntax, DB migration, feature tests)
6. If GitHub tests FAIL: Analyze logs → Fix locally → Re-test locally → Push again
7. Never skip local testing. Never push broken code.
